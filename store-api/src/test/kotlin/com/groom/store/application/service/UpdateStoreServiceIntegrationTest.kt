...
@SpringBootTest
@SqlGroup(
    Sql(scripts = ["/sql/store/cleanup-update-store-service.sql"], executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD),
    Sql(scripts = ["/sql/store/init-update-store-service.sql"], executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD),
    Sql(scripts = ["/sql/store/cleanup-update-store-service.sql"], executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD),
)
class UpdateStoreServiceIntegrationTest {
    @Autowired
