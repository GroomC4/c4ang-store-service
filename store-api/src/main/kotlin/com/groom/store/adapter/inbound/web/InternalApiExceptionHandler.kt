 ...
 * 기대하는 에러 응답 형식(errorCode, message, timestamp, path)으로 반환합니다.
 */
...
class InternalApiExceptionHandler {
    ...
    fun handleStoreNotFoundException(
        e: StoreException.StoreNotFound,
        request: HttpServletRequest,
    ): ResponseEntity<InternalApiErrorResponse> {
